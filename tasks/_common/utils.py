...
class StandardSettings:
    ...
    def __init__(
        ...
        def _init_from_to(
            ...
            from_value = section[key].get('from')
            to_value = section[key].get('to')
        ...
        def _init_from_to_in_percent(
            section: dict[str, dict], 
            key: str
        ) -> FromTo | None:
            from_value = section[key].get('min_percent')
            to_value = section[key].get('max_percent')
        ...
        self.eth_amount = _init_from_to(action_settings, 'eth_amount')
        self.eth_amount_percent = _init_from_to_in_percent(
            action_settings, 'eth_amount'
        )

        self.token_amount = _init_from_to(action_settings, 'token_amount')
        self.token_amount_percent = _init_from_to_in_percent(
            action_settings, 'token_amount'
        )
